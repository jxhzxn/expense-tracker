...
const inputClass = "w-full bg-[var(--c-input)] border border-[var(--c-input-border)] rounded-xl px-3 py-2.5 text-[var(--c-t1)] placeholder-[var(--c-t3)] focus:outline-none focus:border-green-500 focus:ring-2 focus:ring-green-500/20 transition-colors";
    ...
    >
      ...
      >
        <div className="flex items-center gap-2.5 mb-5">
          ...
          <h2 className="text-lg font-semibold" style={{ color: "var(--c-t1)" }}>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label className="block text-sm font-medium mb-1.5" style={{ color: "var(--c-t2)" }}>Source</label>
            <input
          ...
          <div>
            <label className="block text-sm font-medium mb-1.5" style={{ color: "var(--c-t2)" }}>Into Account</label>
          ...
          <div>
            ...
            <input type="text" placeholder="Any notes..." value={note} onChange={(e) => setNote(e.target.value)} className={inputClass} />
          </div>
